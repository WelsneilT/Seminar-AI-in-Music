...
# Cơ sở dữ liệu mẫu
database = {
    "singer1": extract_features("./Music-AI/Someone-You-Loved-Justin-Bieber-_AI-Cover_.wav"), 
    "singer2": extract_features("./Music-AI/Nothing_s-Gonna-Change-My-Love-For-You-Lyrics-Justin-Bieber-_AI-Cover_.wav"),
    "singer3": extract_features("./Music-Human/Justin-Bieber-Off-My-Face-_Visualizer_.wav"), #Justin
    "singer4": extract_features("./Music-AI/Easy-on-me-Justin-Bieber-_-Ai-cover-_-lyrics-_Adele_.wav"),
    "singer5": extract_features("./Music-AI/That-Should-Be-Me-Justin-Bieber-Older-_AI-Cover_.wav"),
}

# Đường dẫn đến file âm thanh bạn muốn xác định ca sĩ
audio_file_to_identify = "./Music-Human/Justin-Bieber-Love-Yourself-_PURPOSE-The-Movement_.wav"
